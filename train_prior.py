...
def pretrain(num_epochs, verbose, restore_from=None):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for step, batch in tqdm(enumerate(data), total=len(data), disable=not verbose):
...
if __name__ == "__main__":
    ...
    pretrain(num_epochs=arg_dict['num_epochs'], verbose=arg_dict['verbose'])
